    ...
    <div className="flex flex-col h-full overflow-y-auto scrollbar-hide">
      ...
      <div className="flex-shrink-0 px-8 pt-8 pb-6 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-6 mt-5">
          <div>
            <p className="text-[10px] text-zinc-400 uppercase tracking-widest mb-0.5">Tasks</p>
            <p className="font-syne font-bold text-lg text-zinc-900 dark:text-white">{sector.tasks.length}</p>
          </div>
          <div className="w-px h-8 bg-zinc-200 dark:bg-zinc-800" />
          <div>
            <p className="text-[10px] text-zinc-400 uppercase tracking-widest mb-0.5">Use Cases</p>
          ...
          <div className="w-px h-8 bg-zinc-200 dark:bg-zinc-800" />
          <div>
            <p className="text-[10px] text-zinc-400 uppercase tracking-widest mb-0.5">Sector</p>
      ...
      <div className="flex-1 px-8 py-6">
        <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 mb-4">Daily Tasks</p>
...
function EmptyPanel() {
  return (
    <div className="flex flex-col items-center justify-center h-full gap-4 px-8 text-center">
      ...
      <div>
        <p className="font-syne font-bold text-zinc-900 dark:text-white mb-1">Select a sector</p>
        <p className="text-sm text-zinc-500 max-w-xs leading-relaxed">
          Choose a sector from the left to view its tasks and recommendations
        </p>
      </div>
    </div>
  )
      ...
      <div className="w-64 flex-shrink-0 flex flex-col border-r border-zinc-100 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/60">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-zinc-400 mt-0.5">{sector.tasks.length} tasks</p>
                </div>
        ...
        <div className="px-4 py-4 border-t border-zinc-100 dark:border-zinc-800">
          <p className="text-[10px] text-zinc-400 leading-relaxed">
            {SECTOR_LIST.length} sectors · {SECTOR_LIST.reduce((acc, s) => acc + s.tasks.length, 0)} tasks
          </p>
        </div>
      </div>
