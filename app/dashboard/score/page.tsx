...
export default async function ScorePage() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="mb-10">
        <h1 className="font-syne font-black text-4xl text-white tracking-tighter mb-2">Stack Score</h1>
        <p className="text-zinc-500 text-sm">Évaluation de la qualité et de l'efficacité de tes stacks IA.</p>
      </div>

      {stacks.length === 0 ? (
        <div className="border border-dashed border-zinc-800 p-16 text-center">
          <p className="font-syne font-black text-white text-2xl mb-3">Aucun stack à évaluer</p>
          <p className="text-zinc-500 text-sm mb-8">Génère ton premier stack pour obtenir ton score.</p>
        ...
        <>
          {/* Score global */}
          <div className="bg-zinc-900/50 border border-zinc-800 p-8 mb-6 flex items-center gap-8">
            ...
            <div>
              ...
              <p className="font-syne font-black text-white text-2xl mb-1">
          ...
          <div className="flex flex-col gap-3">
            {CRITERIA.map((c, i) => (
              <div key={i} className="bg-zinc-900/50 border border-zinc-800 p-5">
                ...
                <p className="text-zinc-600 text-xs">{c.desc}</p>
              </div>
            ))}
          </div>
        </>
