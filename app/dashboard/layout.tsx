      ...
      <aside className={cn(
        ...
        <nav className="flex-1 px-2 py-4 flex flex-col gap-0.5 overflow-y-auto scrollbar-hide">
          ...
          <Link href="/dashboard/recommend"
            ...
            />
            {!collapsed && <span suppressHydrationWarning className="text-[13px] font-bold tracking-wide whitespace-nowrap font-sans">New Stack</span>}
            ...
            <div className={cn(
              ...
              <div className="py-1.5">
                ...
                <Link href="/dashboard/account"
                  ...
                  <Image src="/assets/icons svg/user-stroke-rounded.svg" alt="Account" width={15} height={15} className="opacity-50 dark:invert w-4" />
                  Account
                </Link>
                <Link href="/dashboard/settings"
                  onClick={() => setUserMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-2.5 text-[13px] text-zinc-700 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-700/50 transition-colors rounded-lg mx-1 w-[calc(100%-8px)]">
                  <Image src="/assets/icons svg/setting-07-stroke-rounded.svg" alt="Settings" width={15} height={15} className="opacity-50 dark:invert w-4" />
                  Settings
                </Link>

                {/* Language row removed - no longer needed */}
              </div>
              ...
              <div className="py-1.5 border-t border-zinc-200 dark:border-white/8">
                <Link href="/dashboard/billing"
                  onClick={() => setUserMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-2.5 text-[13px] text-zinc-700 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-700/50 transition-colors rounded-lg mx-1 w-[calc(100%-8px)]">
                  <Image src="/assets/icons svg/add-money-circle-stroke-rounded.svg" alt="Billing" width={15} height={15} className="opacity-50 dark:invert w-4" />
                  Billing
                </Link>
              </div>
              ...
              <div className="py-1.5 border-t border-zinc-200 dark:border-white/8">
                <button
                  ...
                  <Image src="/assets/icons svg/delivery-return-02-stroke-rounded.svg" alt="Sign Out" width={15} height={15} className="opacity-50 dark:invert w-4" />
                  Sign Out
                </button>
              </div>
              </div>{/* bg layer */}
